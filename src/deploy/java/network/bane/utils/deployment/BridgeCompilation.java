...
public class BridgeCompilation {
    ...
    private static final String ownerWalletPath = WALLET_FILEPATH_OWNER;
    private static final String ownerWalletPassword = WALLET_PASSWORD_OWNER;
    ...
    private static final String managementContractName = MANAGEMENT_CONTRACT_NAME;
    private static final String bridgeContractName = BRIDGE_CONTRACT_NAME;
    private static final BigInteger linkedChainId = LINKED_CHAIN_ID;

    // Roles
    private static final Hash160 owner = ROLE_OWNER_ADDRESS;
    private static final Hash160 relayer = ROLE_RELAYER_ADDRESS;
    private static final Hash160 governor = ROLE_GOVERNOR_ADDRESS;
    private static final Hash160 securityGuard = ROLE_SECURITY_GUARD_ADDRESS;
    private static final int validatorThreshold = MANAGEMENT_VALIDATOR_THRESHOLD;
    private static final int nrValidators = MANAGEMENT_NUMBER_OF_VALIDATORS;
    public static final ECKeyPair.ECPublicKey validator01 = ROLE_VALIDATOR_01_PUBLIC_KEY;
    public static final ECKeyPair.ECPublicKey validator02 = ROLE_VALIDATOR_02_PUBLIC_KEY;
    public static final ECKeyPair.ECPublicKey validator03 = ROLE_VALIDATOR_03_PUBLIC_KEY;
    public static final ECKeyPair.ECPublicKey validator04 = ROLE_VALIDATOR_04_PUBLIC_KEY;
    public static final ECKeyPair.ECPublicKey validator05 = ROLE_VALIDATOR_05_PUBLIC_KEY;
    public static final ECKeyPair.ECPublicKey validator06 = ROLE_VALIDATOR_06_PUBLIC_KEY;
    public static final ECKeyPair.ECPublicKey validator07 = ROLE_VALIDATOR_07_PUBLIC_KEY;
    ...
    public static Hash160 compileAndPrintManagementDeploymentTxData(Neow3j neow3j) throws Throwable {
        ...
        List<ECKeyPair.ECPublicKey> completeValidatorList = asList(validator01, validator02, validator03, validator04,
                validator05, validator06, validator07);
